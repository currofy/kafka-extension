...
`com.github.fmcejudo.kafka.extensions.opentracing.serialization.OpentracingSerde`
...
`com.github.fmcejudo.kafka.extensions.group.aggregator.NodeTraceAggregator`
...
----
    <dependency>
        <groupId>com.github.fmcejudo.kafka.extensions</groupId>
          ...
          bindings:
            metrics_in:
              consumer:
                ...
                value-serde: com.github.fmcejudo.kafka.extensions.opentracing.serialization.OpentracingSerde
